...
func forceprune() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			cmdr := exec.Command("blackfuryd", "status")
			err = cmdr.Run()
